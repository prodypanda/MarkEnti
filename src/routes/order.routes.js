...
router.put('/:id/status', isAuthenticated, calculatePreferencesOnOrderCompletion, orderController.updateOrderStatus);
...
router.get('/customer/:customerId', isAuthenticated, orderController.getCustomerOrders);

// Add route to record payment failure
router.post('/:id/payment-failure', isAuthenticated, orderController.recordPaymentFailure);
